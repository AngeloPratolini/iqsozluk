...
_django = "docker exec -it iqsozluk_backend python manage.py"
...
def main(parser, environment):  # noqa
    ...
    command_map = {
        ...
        "console": "docker exec -it iqsozluk_backend /bin/bash",
        "setup": "docker exec -it iqsozluk_backend sh ./scripts/setup.sh",
    }
...
def get_environment():
    ...
    if environment is None:
        print(assertive("No environment specified, defaulting to production."))
        return "production"
